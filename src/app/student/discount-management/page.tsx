...
// Split out of Specialization Management per request — this used to share
// that page purely by accident of the old isbat_student_module.html mockup
// grouping them together, and was a mock-only "%-off type list" with no
// backend contract of its own. Turns out that resource already exists for
// real: students/student-discounts/get-student-discount.md's own
// discountGuid/discountCode/discountName/calcType fields are exactly
// Finance's Discount master (GET/POST/PUT/DELETE /api/v1/finance/discounts,
// same one Finance > Discount Master and the Student Profile page's
// discount-assignment modal already read from) — not a separate resource
// this page needs its own mock/CRUD for. Reuses that same
// hooks/useDiscounts.ts + DiscountFormModal/ViewDiscountModal wholesale
// rather than re-implementing identical CRUD against the identical
// endpoint from a second page.
const PAGE_SIZE = 10
    ...
    <>
      <div className="page active">
        <div className="pg-hdr">
          <div>
            <div className="pg-title">Discount Management</div>
            <div className="pg-sub">Configure discounts applied to tuition</div>
          </div>
          {permissions.add && (
