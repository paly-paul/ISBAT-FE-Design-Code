        ...
        <div className="card">
          ...
          <ScrollTable>
            <table>
              ...
              <tbody>
                <tr><td><span className="text-blue font-bold font-mono">ISB/2026/0142</span></td><td><strong>Nakato Sarah Bridget</strong><div className="text-[11px] text-g500">nakato.s@students.isbatuniversity.ac.ug</div></td><td>BSc. Computer Science</td><td>Year 1 · Sem 1</td><td>Spring 2026</td><td><span className="badge badge-blue">2025–2026</span></td><td><span className="badge badge-green">Cleared 100%</span></td><td><span className="badge badge-green"><span className="bdot"></span>Active</span></td><td><div className="flex gap-2"><button className="btn btn-neu btn-sm"><i className="lni lni-eye"></i> View</button><button className="btn btn-primary btn-sm"><i className="lni lni-pencil"></i> Edit</button></div></td></tr>
                <tr><td><span className="text-blue font-bold font-mono">ISB/2026/0141</span></td><td><strong>Okello James Patrick</strong><div className="text-[11px] text-g500">okello.j@students.isbatuniversity.ac.ug</div></td><td>MBA Business Admin (ODL)</td><td>Year 1 · Sem 1</td><td>Spring 2026</td><td><span className="badge badge-blue">2025–2026</span></td><td><span className="badge badge-green">Cleared 100%</span></td><td><span className="badge badge-green"><span className="bdot"></span>Active</span></td><td><div className="flex gap-2"><button className="btn btn-neu btn-sm"><i className="lni lni-eye"></i> View</button><button className="btn btn-primary btn-sm"><i className="lni lni-pencil"></i> Edit</button></div></td></tr>
                <tr><td><span className="text-blue font-bold font-mono">ISB/2026/0140</span></td><td><strong>Tumukunde Alice Grace</strong><div className="text-[11px] text-g500">tumukunde.a@students.isbatuniversity.ac.ug</div></td><td>Diploma in Nursing</td><td>Year 1 · Sem 1</td><td>Spring 2026</td><td><span className="badge badge-blue">2025–2026</span></td><td><span className="badge badge-amber">Partial 60%</span></td><td><span className="badge badge-green"><span className="bdot"></span>Active</span></td><td><div className="flex gap-2"><button className="btn btn-neu btn-sm"><i className="lni lni-eye"></i> View</button><button className="btn btn-primary btn-sm"><i className="lni lni-pencil"></i> Edit</button></div></td></tr>
                <tr><td><span className="text-blue font-bold font-mono">ISB/2025/0089</span></td><td><strong>Mugume Robert</strong><div className="text-[11px] text-g500">mugume.r@students.isbatuniversity.ac.ug</div></td><td>BSc. Information Technology</td><td>Year 1 · Sem 2</td><td>Fall 2025</td><td><span className="badge badge-blue">2025–2026</span></td><td><span className="badge badge-red">Outstanding 35%</span></td><td><span className="badge badge-amber"><span className="bdot"></span>Access Blocked</span></td><td><div className="flex gap-2"><button className="btn btn-neu btn-sm"><i className="lni lni-eye"></i> View</button><button className="btn btn-primary btn-sm"><i className="lni lni-pencil"></i> Edit</button></div></td></tr>
                <tr><td><span className="text-blue font-bold font-mono">ISB/2024/0028</span></td><td><strong>Akello Diana</strong><div className="text-[11px] text-g500">akello.d@students.isbatuniversity.ac.ug</div></td><td>BBA</td><td>Year 2 · Sem 4</td><td>Spring 2024</td><td><span className="badge badge-grey">2023–2024</span></td><td><span className="badge badge-green">Cleared 100%</span></td><td><span className="badge badge-green"><span className="bdot"></span>Active</span></td><td><div className="flex gap-2"><button className="btn btn-neu btn-sm"><i className="lni lni-eye"></i> View</button><button className="btn btn-primary btn-sm"><i className="lni lni-pencil"></i> Edit</button></div></td></tr>
              </tbody>
            </table>
          </ScrollTable>
        </div>
