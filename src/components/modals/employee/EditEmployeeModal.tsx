...
// Only one employee category is confirmed for now.
...
export function EditEmployeeModal({ isOpen, onClose, showToast, employeeGuid }: EditEmployeeModalProps) {
  const [saved, setSaved] = useState(false)
  const [department, setDepartment] = useState('')
  const [designation, setDesignation] = useState('')

  // These fields match the employee update payload.
  ...
  // Reuse the API validation messages so issues appear in the form immediately.
  ...
  useEffect(() => {
    ...
    setErrors({})
  }, [isOpen, employee, departments, designations])
    ...
    <div className="modal-overlay open" id="edit-employee-modal">
      <div className="modal modal-80 modal-flex" onClick={e => e.stopPropagation()}>
        ...
        <div className="modal-scroll">
          ...
          <div className="g3">
            ...
            <div className="fg">
              ...
              <input className="ctrl" type="text" value={firstName} onChange={e => { setFirstName(e.target.value); clearError('firstName') }} style={errors.firstName ? { borderColor: 'var(--red)' } : undefined} />
            ...
            <div className="fg">
              ...
              <input className="ctrl" type="text" value={surname} onChange={e => { setSurname(e.target.value); clearError('surname') }} style={errors.surname ? { borderColor: 'var(--red)' } : undefined} />
            ...
            <div className="fg">
              ...
              <input className="ctrl" type="email" value={emailId} onChange={e => { setEmailId(e.target.value); clearError('emailId') }} style={errors.emailId ? { borderColor: 'var(--red)' } : undefined} />
            ...
            <div className="fg">
              ...
              <input className="ctrl" type="text" value={placeOfBirth} onChange={e => { setPlaceOfBirth(e.target.value); clearError('placeOfBirth') }} style={errors.placeOfBirth ? { borderColor: 'var(--red)' } : undefined} />
            ...
            <div className="fg">
              ...
              <input className="ctrl" type="text" value={nationalId} onChange={e => { setNationalId(e.target.value); clearError('nationalId') }} style={errors.nationalId ? { borderColor: 'var(--red)' } : undefined} />
        ...
        <div className="modal-footer">
          ...
          <button className="btn btn-primary" disabled={updateEmployee.isPending} onClick={handleSave}>
            <i className="lni lni-checkmark"></i> {updateEmployee.isPending ? 'Saving…' : 'Update Employee'}
          </button>
        </div>
      </div>
    </div>
