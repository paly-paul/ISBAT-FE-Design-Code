...
export function EditCountryModal({ isOpen, onClose, showToast }: ModalProps) {
      ...
      <div className="modal modal-md" onClick={e => e.stopPropagation()}>
        ...
        <div className="g2">
          <div className="fg">
            ...
            <input className="ctrl font-mono uppercase" type="text" defaultValue="UG" maxLength={3} />
          </div>
          <div className="fg">
            <div className="lbl">Dial Code <span className="req">*</span></div>
            <input className="ctrl font-mono" type="text" defaultValue="+256" maxLength={6} />
          </div>
          <div className="fg span2">
            <div className="lbl">Country Name <span className="req">*</span></div>
            <input className="ctrl" type="text" defaultValue="Uganda" />
          </div>
          <div className="fg">
            <div className="lbl">Nationality</div>
            <input className="ctrl" type="text" defaultValue="Ugandan" />
          </div>
          <div className="fg">
        ...
        <div className="modal-footer">
          ...
          <button className="btn btn-primary" onClick={() => setSaved(true)}>
            <i className="lni lni-checkmark"></i> Update Country
          </button>
        </div>
      </div>
    </div>
