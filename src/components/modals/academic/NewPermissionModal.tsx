...
import { PermissionGroupInput } from '@/lib/api/academic/permissionGroup'
...
interface NewPermissionModalProps extends ModalProps {
...
export function NewPermissionModal({ isOpen, onClose, showToast, createPermissionGroup }: NewPermissionModalProps) {
  const {
        ...
        <div className="modal-footer">
          {!confirming ? (
            ...
            <>
              ...
              <button className="btn btn-success" disabled={createPermissionGroup.isPending} onClick={handleCreate}>
                <i className="lni lni-checkmark-circle"></i> {createPermissionGroup.isPending ? 'Creating…' : 'Confirm & Create'}
              </button>
            </>
          )}
        </div>
